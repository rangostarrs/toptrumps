			...
			if (x == 1) {
				...
				try {
					...
					while (rs4.next()) {
						...
						System.out.println(
								"There has been approximately " + formatter.format(avg_draws) + " draws per game.");
					...
					while (rs5.next()) {
						...
						System.out.println("The highest number of rounds played in any of the games has been "
								+ highest_totalrounds + ".");
					}
					rs5.close();
					stm5.close();
